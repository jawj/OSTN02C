...
var OSTN02C, arrow, degFmt, displayGeoid, displayGps, displayOsgb, dmsChanged, formatAlt, formatEOrN, formatLatOrLon, gpsChanged, gpsFields, id, input, j, k, l, len, len1, len2, osgbChanged, osgbFields, parseAlt, parseEorN, parseLatOrLon, ref, showMissing,
...
dmsChanged = function() {
  var field, i, isLat, k, len1, ref1, results, value;
  ...
  for (i = k = 0, len1 = ref1.length; k < len1; i = ++k) {
    ...
    if (value) {
      results.push(field.value = formatLatOrLon(value, isLat));
    } else {
      results.push(void 0);
    }
  }
