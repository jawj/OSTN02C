...
It also includes a simple command-line tool. You can "download the command-line tool as a 32/64-bit Intel binary for Mac OS X 10.4 and above":http://jawj.github.com/OSTN02C/OSTN02C.gz.

Or you can clone the source to your machine and compile it like this:

bc. gcc -std=gnu99 -Wall -pedantic -o OSTN02C main.c OSTN02.c crc32.c
