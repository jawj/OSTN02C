...
Otherwise: (1) ensure you have build tools installed -- Xcode 4 on the Mac, @sudo aptitude install build-essential@ on Debian/Ubuntu, etc.; (2) download or clone the source to your machine; and (3) compile, in the OSTN02 subdirectory:

bc. gcc main.c OSTN02.c crc32.c -std=gnu99 -D_GNU_SOURCE -lm -Wall -O2 -o ostn02c
