...
To compile with long double precision arithmetic, add option @-DUSE_LONG@. To prevent any bold/inverse/underlined output from the tool, add option @-DUNFANCY_OUTPUT@.
