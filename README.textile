...
Otherwise: (1) ensure you have build tools installed (Xcode 4 on the Mac, @sudo aptitude install build-essential@ on Ubuntu, etc.); (2) download or clone the source to your machine; and (3) compile, in the OSTN02 subdirectory:
