...
* Ensure you have build tools installed (Xcode 4 on the Mac, @sudo aptitude install build-essential@ on Ubuntu, etc.)
* Clone the source to your machine
* Compile like so, in the OSTN02 subdirectory:
