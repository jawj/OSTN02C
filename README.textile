...
You can "download the tool as a 32/64-bit Intel binary for Mac OS X 10.4 and above":http://jawj.github.com/OSTN02C/OSTN02C.gz.

h3. From source

Otherwise, clone the source to your machine and compile it either in Xcode 4 or (as tested on Ubuntu 10.04) like so:

bc. gcc -std=gnu99 -lm -D_GNU_SOURCE -Wall -pedantic -o OSTN02C main.c OSTN02.c crc32.c

Or with long double precision arithmetic:

bc. gcc -std=gnu99 -lm -D_GNU_SOURCE -DUSE_LONG -Wall -pedantic -o OSTN02C main.c OSTN02.c crc32.c
...
bc.. dyn204:OSTN02 George$ OSTN02C help
 ...
 OSTN02C -- https://github.com/jawj/OSTN02C -- Built Feb 13 2012 16:06:35 (double precision) 
...
Usage: OSTN02C to-grid [lat lon elevation] converts ETRS89 to OSGB36
       OSTN02C to-gps [easting northing elevation] converts OSGB36 to ETRS89
...
The conversion commands to-grid and to-gps can be used in two ways:
