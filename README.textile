...
OSTN02C -- https://github.com/jawj/OSTN02C -- Built Feb  4 2012 14:46:02 (double precision)

This tool converts ETRS89/WGS84 coordinates to OSGB36 using OSTN02 and OSGM02

Usage: OSTN02 lat lon elevation converts one set of coordinates with human-friendly output
       OSTN02 (without arguments) does batch conversion, reading from STDIN and writing to STDOUT (see below)
       OSTN02 --list-geoids lists the datum name and region for each geoid datum flag
       OSTN02 --test checks embedded data integrity and runs conversion tests with known coordinates
       OSTN02 --help displays this message
...
dyn204:OSTN02 George$ OSTN02C 51.0 -0.5 100.0
