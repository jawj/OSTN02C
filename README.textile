...
OSTN02C — https://github.com/jawj/OSTN02C – Built Feb  3 2012 20:27:54 (double precision).
...
Usage: OSTN02 lat lon elevation converts one set of coordinates with human-friendly output.
       ...
       OSTN02 --tests verifies data integrity and runs conversion tests with known coordinates.
       OSTN02 --help displays this message.

For batch conversion:
* Input rows should have 3 columns — lat, lon and elevation — with any reasonable separator.
* Output rows have 4 comma-separated columns: easting, northing, elevation, and the geoid datum flag (1 – 14).
...
Copyright © George MacKerron 2012 (http://mackerron.com).
...
Incorporated OSTN02 and OSGM02 data are © Crown copyright 2002. All rights reserved.


bc.. dyn204:OSTN02 George$ ./OSTN02C 51.0 -0.5 100.0
ETRS89 in  lat:   51.000000, lon:   -0.500000, elevation:  100.000
OSGB36 out   E:  505349.663,   N:  123360.984, elevation:   54.635 (UK mainland / Newlyn), ref: TQ 0535 2336, tetrad: TQ02L


bc.. dyn204:OSTN02 George$ echo "51.0, -0.5, 100.0
...
bc.. dyn204:OSTN02 George$ ./OSTN02C --tests
