...
It also includes a simple command-line tool, which you can "download as a 32/64-bit Intel binary for Mac OS X 10.4 and above":http://jawj.github.com/OSTN02C/OSTN02C.gz.
